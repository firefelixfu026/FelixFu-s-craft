...
- 管理后台支持写文章、导入 Markdown 笔记、内容库整理、拖拽排序、评论删除、音乐管理、工具箱管理、版本记录、运维、安全日志和备份中心。
- 暑期计划接入数据库保存，并在保存前保留最近计划快照，减少误覆盖风险。
...
这是一个个人学习、技术写作和生活记录项目。功能会随着副将凡自己的使用习惯继续调整，不追求“大而全”，更重视顺手、可维护和有个人气质。
